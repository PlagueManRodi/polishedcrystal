; Johto Pokémon in grass
	...
	db 2 percent ; encounter rates: morn/day/nite
	; morn
	wildmon 20, RATTATA
	wildmon 21, RATTATA
	wildmon 22, RATTATA
	...
	db 2 percent ; encounter rate
	; morn
	wildmon 16, PONYTA, GALARIAN_FORM
	wildmon 16, RATICATE
	wildmon 16, MAGNEMITE
	wildmon 16, PIDGEOTTO
	wildmon 15, MILTANK
